...
const val API_KEY = "411ef9b5-078e-4a57-8844-de83877f2505"
const val DATA = "data"
...
class RandomORG {
    ...
    fun generateString(
        n: Int = 1,
        length: Int = 8,
        charactersToUse: String = "abcdefghijklmnopqrstuvwxyz.:ABCDEFGHIJKLMNOPQRSTUVWXYZ#1234567890;'\"",
    ...
    private fun doResponse(n: Int, requestURL: String) {
        ...
        val root = JsonParser.parseString(response.toString())
